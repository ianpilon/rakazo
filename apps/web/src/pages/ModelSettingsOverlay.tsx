...
export function ModelSettingsOverlay({
  ...
  const description = loading ? (
    ...
    <Trans>Choose which connected model Open Bot uses.</Trans>
  );
            ...
            <>
                ...
                {isOpenAiCompatible ? (
                  <>
                    ...
                    <details className="mt-2 text-[13px] leading-[1.5] text-muted-foreground">
                      ...
                      <p className="mt-1">
                        {t`Paste the OpenAI-compatible address from your server. Open Bot adds /v1 if needed.`}
                      </p>
                    </details>
              ...
              {selected.auth === "oauth" && !subscriptionSignIn ? (
                <p className="mt-5 text-sm leading-[1.5] text-muted-foreground">
                  <Trans>
                    This subscription sign-in is not available in Open Bot yet. Use a deployment
